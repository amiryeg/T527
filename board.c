...
/ {
	...
	#address-cells = <0x02>;
	#size-cells = <0x02>;
	board = "T527\0T527-AXP717B";
	compatible = "allwinner,t527\0arm,sun55iw3p1";
    ...
    /* Sensor Clocks (24MHz fixed for GC2053) */
    clk_gc2053: gc2053-clk {
        #clock-cells = <0>;
        compatible = "fixed-clock";
        clock-frequency = <24000000>;
        clock-output-names = "gc2053_clk";
    };

    /* Regulators for GC2053 (2.8V AVDD, 1.2V DVDD, 1.8V IOVDD) */
    reg_vdd_analog_2v8: vdd-analog-2v8 {
        compatible = "regulator-fixed";
        regulator-name = "vdd_analog_2v8";
    ...
    reg_vdd_digital_1v2: vdd-digital-1v2 {
        compatible = "regulator-fixed";
        regulator-name = "vdd_digital_1v2";
        regulator-min-microvolt = <1200000>;
        regulator-max-microvolt = <1200000>;
        regulator-always-on;
    };

    reg_vdd_io_1v8: vdd-io-1v8 {
        compatible = "regulator-fixed";
	...
	reserved-memory {
		...
		dsp0ddr@4a000000 {
			reg = <0x00 0x4a000000 0x00 0xa00000>;
			no-map;
			phandle = <0x7d>;
		};

		riscvsram0@7280000 {
			reg = <0x00 0x7280000 0x00 0x40000>;
			no-map;
			phandle = <0x84>;
		};

		riscvsram1@72c0000 {
			reg = <0x00 0x72c0000 0x00 0x40000>;
			no-map;
			phandle = <0x85>;
		};

		vdev0buffer@4ac00000 {
			compatible = "shared-dma-pool";
			reg = <0x00 0x4ac00000 0x00 0x40000>;
			no-map;
			phandle = <0x7e>;
		};

		vdev0vring0@4ac40000 {
			reg = <0x00 0x4ac40000 0x00 0x2000>;
			no-map;
			phandle = <0x7f>;
		};

		vdev0vring1@4ac42000 {
			reg = <0x00 0x4ac42000 0x00 0x2000>;
			no-map;
			phandle = <0x80>;
		};

		vdev0buffer@4ae00000 {
			compatible = "shared-dma-pool";
			reg = <0x00 0x4ae00000 0x00 0x40000>;
			no-map;
			phandle = <0x86>;
		};

		vdev0vring0@4ae40000 {
			reg = <0x00 0x4ae40000 0x00 0x2000>;
			no-map;
			phandle = <0x87>;
		};

		vdev0vring1@4ae42000 {
			reg = <0x00 0x4ae42000 0x00 0x2000>;
			no-map;
			phandle = <0x88>;
		};
		...
		dsp0_rpbuf@4ae44000 {
			compatible = "shared-dma-pool";
			no-map;
			reg = <0x00 0x4ae44000 0x00 0x8000>;
			phandle = <0x12f>;
		};

		dsp_share_space@4ab00000 {
			no-map;
			reg = <0x00 0x4ab00000 0x00 0x10000>;
		};
	};
	...
	vf_mapping_table {
		vf-version = "V0.60";
		table = <0x00 0x00 0x01 0x100 0x02 0x200 0x12 0x201 0x04 0x300 0x14 0x301 0x05 0x400 0x06 0x500>;
	};

	gpu_vf_mapping_table {
		table = <0x01 0x01 0x02 0x02 0x12 0x15 0x04 0x03 0x14 0x1f 0x05 0x04 0x06 0x05>;
	};
	...
	dmcfreq@3120000 {
		...
		clocks = <0x1a 0x19 0x2f>;
		clock-names = "dram\0bus";
		operating-points-v2 = <0x1b>;
		upthreshold = <0x3c>;
	...
	soc@3000000 {
		...
		ve@1c0e000 {
			...
			clocks = <0x19 0x3d 0x19 0x3c 0x19 0x5e>;
			clock-names = "bus_ve\0ve\0mbus_ve";
			resets = <0x19 0x08>;
			reset-names = "reset_ve";
			iommus = <0x1d 0x02 0x01>;
			power-domains = <0x1e 0x00>;
			ve-supply = <0x1f>;
			enable_setup_ve_freq = <0x00>;
			ve_freq_value = <0x270>;
		};

		ve1@1c0e000 {
			compatible = "allwinner,sunxi-cedar-ve";
			iommus = <0x1d 0x03 0x01>;
		};
		...
		tcon0@5501000 {
			...
			clocks = <0x19 0xa5 0x19 0xac>;
			clock-names = "clk_tcon\0clk_bus_tcon";
			resets = <0x19 0x44 0x19 0x48>;
			reset-names = "rst_bus_tcon\0rst_bus_lvds";
			top = <0x2e>;
			phys = <0x2f 0x30>;
			phy-names = "lvds_combo_phy0\0lvds_combo_phy1";
			status = "disabled";
			panel = <0x31>;
		...
		tcon4@5731000 {
			...
			clocks = <0x19 0xa7 0x19 0xaa>;
			clock-names = "clk_tcon\0clk_bus_tcon";
			resets = <0x19 0x42 0x19 0x47>;
			reset-names = "rst_bus_tcon\0rst_bus_lvds";
			top = <0x3a>;
			phys = <0x2f 0x30>;
			phy-names = "lvds_combo_phy0\0lvds_combo_phy1";
		...
		phy@5507000 {
			...
			clocks = <0x19 0xa1 0x19 0xa4 0x19 0xa8>;
			clock-names = "clk_mipi_dsi\0clk_bus_mipi_dsi\0clk_mipi_dsi_combphy";
			resets = <0x19 0x41>;
			reset-names = "rst_bus_mipi_dsi";
			#phy-cells = <0x00>;
			status = "okay";
			phandle = <0x2f>;
		};
		...
		phy@5509000 {
			...
			clocks = <0x19 0xa2 0x19 0xa3 0x19 0xa9>;
			clock-names = "clk_mipi_dsi\0clk_bus_mipi_dsi\0clk_mipi_dsi_combphy";
			resets = <0x19 0x40>;
			reset-names = "rst_bus_mipi_dsi";
			#phy-cells = <0x00>;
		...
		tcon2@5503000 {
			compatible = "allwinner,tcon-tv-hdmi";
			reg = <0x00 0x5503000 0x00 0x1000>;
			interrupts = <0x00 0x5b 0x04>;
			clocks = <0x19 0xad 0x19 0xb0>;
			clock-names = "clk_tcon\0clk_bus_tcon";
			resets = <0x19 0x46>;
			reset-names = "rst_bus_tcon";
			top = <0x2e>;
		...
		hdmi@5520000 {
			...
			clocks = <0x19 0xa0 0x19 0x9e 0x19 0x9f 0x19 0xad>;
			clock-names = "clk_hdmi\0clk_hdmi_24M\0clk_cec\0clk_tcon_tv";
			resets = <0x19 0x3e 0x19 0x3f>;
			reset-names = "rst_bus_sub\0rst_bus_main";
			assigned-clocks = <0x19 0xa0>;
			...
			ddc_en_io_ctrl = <0x00>;
			power_io_ctrl = <0x00>;
			inno_phy = <0x61a8 0x28488 0x1000102 0x1c1c1c1c 0x00 0x00 0x28488 0x53020 0x1040506 0x1c1c1c1c 0x00 0x3030300 0x53020 0x927c0 0x10f0f0f 0x1c1c1c1c 0x00 0x00>;
			phandle = <0x113>;
		...
		drm_edp@5720000 {
			...
			power-domains = <0x1e 0x03>;
			clocks = <0x19 0xb2 0x19 0xb1 0x19 0x9e>;
			clock-names = "clk_bus_edp\0clk_edp\0clk_24m_edp";
			resets = <0x19 0x49>;
			reset-names = "rst_bus_edp";
			assigned-clocks = <0x19 0xb1>;
			assigned-clock-parents = <0x19 0x1b>;
			status = "disabled";
			edp_ssc_en = <0x00>;
			edp_ssc_mode = <0x00>;
		...
		disp@5000000 {
			...
			clocks = <0x19 0x31 0x19 0x31 0x19 0x32 0x19 0x32 0x19 0xa5 0x19 0xa6 0x19 0xad 0x19 0xae 0x19 0xa7 0x19 0xac 0x19 0xab 0x19 0xb0 0x19 0xaf 0x19 0xaa 0x19 0x9c 0x19 0x9c 0x19 0x9c 0x19 0x9c 0x19 0x9d 0x19 0xa1 0x19 0xa2 0x19 0xa4 0x19 0xa3 0x19 0xa8 0x19 0xa9>;
			...
			resets = <0x19 0x02 0x19 0x02 0x19 0x44 0x19 0x43 0x19 0x46 0x19 0x45 0x19 0x42 0x19 0x48 0x19 0x47 0x19 0x3c 0x19 0x3c 0x19 0x3c 0x19 0x3c 0x19 0x3d 0x19 0x41 0x19 0x40>;
			...
			assigned-clocks = <0x19 0x31 0x19 0xa5 0x19 0xa6 0x19 0xa7 0x19 0xad 0x19 0xae 0x19 0xa8 0x19 0xa9 0x19 0xa1 0x19 0xa2 0x19 0xb1>;
			assigned-clock-parents = <0x19 0x20 0x19 0x19 0x19 0x1b 0x19 0x1b 0x19 0x1b 0x19 0x1b 0x19 0x19 0x19 0x1b 0x19 0x0c 0x19 0x0c 0x19 0x1b>;
			assigned-clock-rates = <0x23c34600>;
			iommus = <0x1d 0x05 0x00>;
			power-domains = <0x1e 0x05 0x1e 0x03 0x1e 0x04>;
			power-domain-names = "pd_de\0pd_vo0\0pd_vo1";
			status = "okay";
			boot_disp = <0x00>;
			fb_base = <0x00>;
			disp_init_enable = <0x01>;
			disp_mode = <0x00>;
			screen0_output_type = <0x01>; // lcd
			screen0_output_mode = <0x04>; // 720p50
			screen0_to_lcd_index = <0x00>;
			screen1_output_type = <0x03>; // hdmi
			screen1_output_mode = <0x05>; // 720p60
			screen1_to_lcd_index = <0x02>;
			screen1_output_format = <0x00>; // rgb
			screen1_output_bits = <0x00>; // 8bit
			screen1_output_eotf = <0x04>; // sdr
			screen1_output_cs = <0x101>; // 257:BT709
			screen1_output_dvi_hdmi = <0x02>; // hdmi mode
			screen1_output_range = <0x02>; // limited
			screen1_output_scan = <0x00>; // no data
			screen1_output_aspect_ratio = <0x08>; // same as original picture
			dev0_output_type = <0x01>; // lcd
			dev0_output_mode = <0x04>;
			dev0_screen_id = <0x00>;
			dev0_do_hpd = <0x00>;
			dev1_output_type = <0x04>; // hdmi
			dev1_output_mode = <0x0a>;
			dev1_screen_id = <0x01>;
			dev1_do_hpd = <0x01>;
			def_output_dev = <0x00>;
			hdmi_mode_check = <0x01>;
			display_device_num = <0x03>;
			primary_display_type = "LCD";
			primary_de_id = <0x00>;
			primary_framebuffer_width = <0x320>; // 800
			primary_framebuffer_height = <0x1e0>; // 480
			primary_dpix = <0xd5>; // 213
			primary_dpiy = <0xd5>; // 213
			extend0_display_type = "HDMI";
			extend0_de_id = <0x01>;
			extend0_framebuffer_width = <0x780>; // 1920
			extend0_framebuffer_height = <0x438>; // 1080
			extend0_dpix = <0xa0>; // 160
			extend0_dpiy = <0xa0>; // 160
			extend1_display_type = "DP";
			extend1_de_id = <0x01>;
			extend1_framebuffer_width = <0x780>;
			extend1_framebuffer_height = <0x438>;
			extend1_dpix = <0xa0>;
			extend1_dpiy = <0xa0>;
			fb_format = <0x00>;
			fb_num = <0x02>;
			...
			fb0_width = <0x320>; // 800
			fb0_height = <0x1e0>; // 480
			fb1_map = <0x01 0x01 0x00 0x10>;
			fb1_width = <0x320>; // 800
			fb1_height = <0x1e0>; // 480
			fb2_map = <0x01 0x00 0x00 0x10>;
			fb2_width = <0x320>; // 800
			fb2_height = <0x1e0>; // 480
			fb3_map = <0x01 0x01 0x00 0x10>;
			fb3_width = <0x320>; // 800
			fb3_height = <0x1e0>; // 480
			chn_cfg_mode = <0x03>;
			disp_para_zone = <0x01>;
			cldo3-supply = <0x4d>;
			dcdc4-supply = <0x4e>;
			cldo1-supply = <0x4f>;
			pwms = <0x50 0x0a 0xf4240 0x00>; // PWM0_10 1KHz
			pwm-names = "lvds0_backlight";
                	...
                	default-brightness-level = <0xc8>; // 200 out of 255
		...
		edp0@5720000 {
			...
			edp_bl_en = <0x53 0x08 0x05 0x00>;
			edp_pwm_used = <0x01>;
			edp_pwm_ch = <0x05>;
			edp_pwm_freq = <0xc350>;
			edp_pwm_pol = <0x00>;
			edp_default_backlight = <0xc8>;
			edp_panel_power_0 = "edp-panel";
			vcc-edp-supply = <0x45>;
			vdd-edp-supply = <0x1f>;
			edp-panel-supply = <0x4e>;
		};
		...
		lcd0@1c0c000 {
			...
			lcd_backlight = <0x3e8>; // 1kHz -> 1000 = 0x3e8
			lcd_if = <0x03>;
			lcd_x = <0x320>; // 800
			lcd_y = <0x1e0>; // 480
			lcd_width = <0x6c>; // 108
			...
			lcd_dclk_freq = <0x19>;
			lcd_pwm_used = <0x01>;
			lcd_pwm_ch = <0x0a>; // PWM0_10
			lcd_pwm_freq = <0xC8>; // 200 out of 255
			lcd_pwm_pol = <0x00>;
			...
			lcd_power = "dcdc4";
			lcd_power1 = "cldo1";
			//lcd_gpio_0 = <0x53 0x08 0x02 0x00>;
			//lcd_bl_en = <0x53 0x08 0x02 0x00>;
			pinctrl-0 = <0x54>;
			pinctrl-1 = <0x55>;
			lvds0_pinctrl-0 = <0x54>;
			lvds0_pinctrl-1 = <0x55>;
			lvds1_pinctrl-0 = <0x56>;
			lvds1_pinctrl-1 = <0x57>;
			dsi0_pinctrl-0 = <0x58>;
			dsi0_pinctrl-1 = <0x59>;
			dual_dsi_pinctrl-0 = <0x58 0x5a>;
			dual_dsi_pinctrl-1 = <0x59 0x5b>;
			dual_lvds0_pinctrl-0 = <0x54 0x56>;
			dual_lvds0_pinctrl-1 = <0x55 0x57>;
		};
		...
		lcd2@1c0c000 {
			...
			lcd_pin_power = "cldo3";
			lcd_power = "dcdc4";
			lcd_bl_en = <0x53 0x08 0x05 0x00>;
			pinctrl-0 = <0x5c>;
			pinctrl-1 = <0x5d>;
			lvds2_pinctrl-0 = <0x5c>;
			lvds2_pinctrl-1 = <0x5d>;
			//lvds3_pinctrl-0 = <0x5e>;
			//lvds3_pinctrl-1 = <0x5f>;
			dual_lvds1_pinctrl-0 = <0x5c 0x5e>;
			dual_lvds1_pinctrl-1 = <0x5d 0x5f>;
		};
		...
		pinctrl@7022000 {
			...
			clocks = <0x19 0x02 0x21 0x22 0x04>;
		...
		g2d@5440000 {
			...
			clocks = <0x19 0x36 0x19 0x35>;
			clock-names = "bus\0g2d";
			resets = <0x19 0x04>;
			iommus = <0x1d 0x04 0x01>;
			power-domains = <0x1e 0x03>;
			power-domain-names = "pd1_vo0";
			assigned-clocks = <0x19 0x35>;
		...
		pinctrl@2000000 {
			...
			clocks = <0x19 0x2d 0x21 0x22 0x04>;
			clock-names = "apb\0hosc\0losc";
			gpio-controller;
			#gpio-cells = <0x03>;
			interrupt-controller;
			...
			i2s3@1 {
				pins = "PF0\0PF1\0PF2\0PF3\0PF4\0PF5\0PF6";
				function = "io_disabled";
				drive-strength = <0x14>;
				bias-disable;
			};
			...
			gmac0@0 {
				pins = "PH0\0PH1\0PH2\0PH3\0PH4\0PH5\0PH6\0PH7\0PH9\0PH10\0PH13\0PH14\0PH15\0PH16\0PH17\0PH18";
				drive-strength = <0x28>;
				function = "gmac0";
				bias-pull-up;
				phandle = <0x126>;
		...
		pinctrl_test@2000000 {
			...
			test-gpios = <0x53 0x01 0x04 0x01>;
			suspend-gpios = <0x64 0x00 0x04 0x01>;
			wakeup-source;
		...
		timer@3008000 {
			...
			clocks = <0x21 0x19 0x43 0x19 0x49 0x19 0x4a>;
			resets = <0x19 0x0d>;
		};
		...
		soft_jtag_master@0 {
			...
			tdi-gpios = <0x64 0x00 0x02 0x00>;
			tdo-gpios = <0x64 0x00 0x03 0x00>;
			tck-gpios = <0x53 0x01 0x0b 0x00>;
			tms-gpios = <0x53 0x01 0x0c 0x00>;
			status = "disabled";
		};
		...
		dma1-controller@7121000 {
			...
			clocks = <0x79 0x22 0x79 0x27 0x79 0x26>;
		...
		npu@7122000 {
			...
			clocks = <0x19 0x3e 0x19 0x28 0x79 0x18 0x79 0x19>;
		...
		dsp0_rproc@0 {
			...
			clocks = <0x19 0x02 0x79 0x04 0x19 0xbc 0x79 0x17 0x18 0x00>;
			clock-names = "pll\0mcu-mod\0mod\0cfg\0ahbs";
			resets = <0x79 0x0b 0x79 0x08 0x79 0x0c>;
			...
			power-domains = <0x20 0x00 0x20 0x03>;
			power-domain-names = "pd_dsp\0pd_sram";
			status = "okay";
			mboxes = <0x7c 0x04>;
			mbox-names = "arm-kick";
			memory-region = <0x7d 0x7e 0x7f 0x80 0x81 0x82 0x83>;
			memory-mappings = <0x20000 0x20000 0x20000 0x400000 0x10000 0x20000 0x420000 0x8000 0x30000 0x440000 0x8000 0x38000 0x10000000 0x10000000 0x40000000 0x20020000 0x10000 0x400000 0x20030000 0x8000 0x420000 0x20038000 0x8000 0x440000 0x30000000 0x10000000 0x40000000 0x40000000 0x40000000 0x40000000 0x80000000 0x40000000 0x40000000 0xc0000000 0x40000000 0x40000000>;
			phandle = <0x12e>;
		};

		e906_rproc@7130000 {
			compatible = "allwinner,e906-rproc";
			clocks = <0x79 0x25 0x79 0x28 0x79 0x29>;
			clock-names = "pubsram\0mod\0cfg";
			resets = <0x79 0x0e 0x79 0x0f 0x79 0x11 0x79 0x10>;
			reset-names = "pubsram-rst\0mod-rst\0cfg-rst\0dbg-rst";
			firmware-name = "amp_rv0.bin";
			reg = <0x00 0x7130000 0x00 0x1000>;
			reg-names = "e906-cfg";
			power-domains = <0x20 0x04 0x20 0x03>;
			power-domain-names = "pd_riscv\0pd_sram";
			status = "okay";
			mboxes = <0x7c 0x08>;
			mbox-names = "arm-kick";
			memory-region = <0x84 0x85 0x86 0x87 0x88>;
			memory-mappings = <0x20000 0x20000 0x20000 0x40000 0x24000 0x40000 0x8000000 0x37f00000 0x8000000 0x3ffc0000 0x40000 0x7280000 0x40000000 0x40000 0x72c0000 0x40040000 0x3ffc0000 0x40040000>;
		};
		...
		pwm0@2000c00 {
			...
			pwm-number = <0x10>;
			pwm-base = <0x00>;
			sunxi-pwms = <0x89 0x8a 0x8b 0x8c 0x8d 0x8e 0x8f 0x90 0x91 0x92 0x93 0x94 0x95 0x96 0x97 0x98>;
			status = "okay";
			phandle = <0x50>;
		};
		...
		pwm1@2051000 {
			...
			pwm-number = <0x04>;
			pwm-base = <0x10>;
			sunxi-pwms = <0xa3 0xa4 0xa5 0xa6>;
			status = "disabled";
		};
		...
		mcu_pwm0@7103000 {
			...
			clocks = <0x79 0x2b 0x79 0x2c>;
			interrupts = <0x00 0xcf 0x04>;
			clock-names = "clk_pwm\0clk_bus_pwm";
			resets = <0x79 0x13>;
			pwm-number = <0x08>;
			pwm-base = <0x16>;
			sunxi-pwms = <0xa9 0xaa 0xab 0xac 0xad 0xae 0xaf 0xb0>;
			status = "disabled";
		};
		...
		irrx@2005000 {
			...
			clocks = <0x19 0x86 0x21 0x19 0x85>;
		...
		s_irrx@7040000 {
			...
			clocks = <0x18 0x19 0x21 0x18 0x18>;
			clock-names = "bus\0pclk\0mclk";
			resets = <0x18 0x0d>;
			status = "disabled";
			pinctrl-names = "default\0sleep";
		...
		irtx@2003000 {
			...
			clocks = <0x19 0x88 0x21 0x19 0x87>;
			clock-names = "bus\0pclk\0mclk";
			resets = <0x19 0x2c>;
			status = "disabled";
			pinctrl-names = "default\0sleep";
		...
		twi4@2503000 {
			...
			ft5x06: ft5x06@38 {
				...
				// We use touch in polling mode
                        	//interrupt-parent = <&pio>;
                        	//interrupts = <PJ 19 IRQ_TYPE_EDGE_FALLING>;
                        	reset-gpios = <0x53 0x09 0x12 0x01>; // PJ18
		...
		s_twi0@7081400 {
			...
			pmu@35 {
				...
				pmu_over_current = <0x01>;
				pmu_hot_shutdown_value = <0x7d>;
				wakeup-source;
				...
				usb_power_supply {
					...
					wakeup_usb_in;
					wakeup_usb_out;
					det_acin_supply = <0xce>;
					pmu_acin_usbid_drv = <0x53 0x07 0x0c 0x01>;
					pmu_vbus_det_gpio = <0x53 0x08 0x0d 0x01>;
					phandle = <0xcf>;
				};
				...
				gpio_power_supply {
					...
					status = "disabled";
					pmu_acin_det_gpio = <0x53 0x07 0x0e 0x01>;
					det_usb_supply = <0xcf>;
					phandle = <0xce>;
				};
				...
				bat-power-supply {
					...
					pmu_jetia_en = <0x01>;
					pmu_bat_charge_ltf = <0x6ca>;
					pmu_bat_charge_htf = <0x96>;
					pmu_bat_shutdown_ltf = <0x84d>;
					pmu_bat_shutdown_htf = <0x82>;
					pmu_jetia_cool = <0x56e>;
					pmu_jetia_warm = <0xce>;
					pmu_jcool_ifall = <0x02>;
					pmu_jwarm_ifall = <0x02>;
					pmu_bat_temp_para1 = <0x11f0>;
		...
		s_twi1@7081800 {
			...
			gc2053_ir: gc2053@37 {
				compatible = "galaxycore,gc2053";
        			reg = <0x37>;  /* I2C addr from detection */
        			reset-gpios = <&r_pio PM 0 GPIO_ACTIVE_LOW>;  /* PM0 */
        			clocks = <&clk_gc2053>;
        			clock-frequency = <24000000>;
        			avdd-supply = <&reg_vdd_analog_2v8>;
        			dvdd-supply = <&reg_vdd_digital_1v2>;
        			iovdd-supply = <&reg_vdd_io_1v8>;
        			status = "okay";

        			port {
            				gc2053_ir_out: endpoint {
                				remote-endpoint = <&mipi_csi_a_in>;
                				data-lanes = <1 2>;  /* D0=1, D1=2 */
                				clock-lanes = <0>;
                				link-freq = /bits/ 64 <594000000>;  /* 594Mbps/lane */
            				};
        			};
    			};
		};
		...
		spi@4025000 {
			...
			clocks = <0x19 0x08 0x19 0x79 0x19 0x80>;
			clock-names = "pll\0mod\0bus";
			resets = <0x19 0x28>;
			dmas = <0xb1 0x16 0xb1 0x16>;
			dma-names = "tx\0rx";
			status = "disabled";
			...
			sunxi,spi-bus-mode = <0x10>;
			sunxi,spi-cs-mode = <0x01>;
		...
		spi@4026000 {
			...
			clocks = <0x19 0x08 0x19 0x7a 0x19 0x7f>;
			clock-names = "pll\0mod\0bus";
			resets = <0x19 0x27>;
			dmas = <0xb1 0x17 0xb1 0x17>;
			dma-names = "tx\0rx";
			status = "disabled";
		};
		...
		spi@4027000 {
			...
			clocks = <0x19 0x08 0x19 0x7b 0x19 0x7e>;
			clock-names = "pll\0mod\0bus";
			resets = <0x19 0x26>;
			dmas = <0xb1 0x18 0xb1 0x18>;
			dma-names = "tx\0rx";
			status = "disabled";
		};
		...
		spi@7092000 {
			...
			clocks = <0x19 0x08 0x18 0x0b 0x18 0x0c>;
			clock-names = "pll\0mod\0bus";
			resets = <0x18 0x03>;
			dmas = <0xc6 0x0d 0xc6 0x0d>;
			dma-names = "tx\0rx";
			status = "disabled";
			pinctrl-0 = <0xe6>;
			pinctrl-1 = <0xe7>;
			...
			st7789v@0 {
				...
				fps = <0x1e>;
				buswidth = <0x08>;
				reset = <0x64 0x00 0x09 0x01>;
				dc = <0x64 0x00 0x0d 0x01>;
				led = <0x64 0x00 0x08 0x00>;
				debug = <0x01>;
			};
		};
		...
		spif@47f0000 {
			...
			clocks = <0x19 0x07 0x19 0x7c 0x19 0x7d>;
		...
		nand0@4011000 {
			...
			clocks = <0x19 0x13 0x19 0x62 0x19 0x63 0x19 0x61 0x19 0x5c>;
		...
		ce@3040000 {
			...
			clocks = <0x19 0x3b 0x19 0x39 0x19 0x5d 0x19 0x07 0x19 0x3a>;
		...
		rtc@7090000 {
			...
			clocks = <0x18 0x1b 0x22 0x07 0x22 0x09>;
		...
		sdmmc@4020000 {
			...
			clocks = <0x21 0x19 0x13 0x19 0x14 0x19 0x64 0x19 0x69>;
		...
		sdmmc@4022000 {
			...
			clocks = <0x21 0x19 0x10 0x19 0x12 0x19 0x66 0x19 0x67>;
			clock-names = "osc24m\0pll_periph\0pll_periph_2\0mmc\0ahb";
			resets = <0x19 0x13>;
			reset-names = "rst";
			pinctrl-names = "default\0sleep";
		...
		sdmmc@4021000 {
			...
			clocks = <0x21 0x19 0x13 0x19 0x14 0x19 0x65 0x19 0x68>;
			clock-names = "osc24m\0pll_periph\0pll_periph_2\0mmc\0ahb";
			resets = <0x19 0x14>;
			reset-names = "rst";
			pinctrl-names = "default\0sleep";
		...
		usbc0@10 {
			...
			usb_id_gpio;
			usb_det_vbus_gpio = <0x53 0x08 0x0d 0x00>;
		...
		udc-controller@4100000 {
			...
			clocks = <0x19 0xd1 0x19 0x94>;
			clock-names = "hosc\0bus_otg";
			resets = <0x19 0x33 0x19 0x30>;
			reset-names = "otg\0phy";
			status = "okay";
			det_vbus_supply = <0xcf>;
			phy_range = <0x153>;
		};
		...
		ehci0-controller@4101000 {
			...
			clocks = <0x19 0xd1 0x19 0x96>;
			clock-names = "hosc\0bus_hci";
			resets = <0x19 0x35 0x19 0x30>;
		...
		ohci0-controller@4101400 {
			...
			clocks = <0x19 0xd1 0x19 0x98 0x19 0x8f>;
			clock-names = "hosc\0bus_hci\0ohci";
			resets = <0x19 0x37 0x19 0x30>;
			reset-names = "hci\0phy";
			hci_ctrl_no = <0x00>;
			status = "okay";
			drvvbus-supply = <0xf5>;
		...
		ehci1-controller@4200000 {
			...
			clocks = <0x19 0xd1 0x19 0x95>;
			clock-names = "hosc\0bus_hci";
			resets = <0x19 0x34 0x19 0x31>;
			reset-names = "hci\0phy";
			hci_ctrl_no = <0x01>;
			status = "okay";
			phy_range = <0x153>;
		...
		ohci1-controller@4200400 {
			...
			clocks = <0x19 0xd1 0x19 0x97 0x19 0x90>;
			clock-names = "hosc\0bus_hci\0ohci";
			resets = <0x19 0x36 0x19 0x31>;
			reset-names = "hci\0phy";
			hci_ctrl_no = <0x01>;
			status = "okay";
			phy_range = <0x153>;
		...
		usbc2@12 {
			...
			xhci2-controller@4d00000 {
				...
				dr_mode = "host";
				clocks = <0x19 0x5b 0x19 0x92 0x19 0x91 0x19 0x93>;
		...
		vind@5800800 {
			...
			clocks = <0x19 0xb5 0x19 0x20 0x19 0xb6 0x21 0x19 0x20 0x19 0xb7 0x21 0x19 0x20 0x19 0xb8 0x21 0x19 0x20 0x19 0xb9 0x21 0x19 0x20 0x19 0xbb 0x19 0x1d 0x19 0xba 0x19 0x5a 0x19 0x59>;
			...
			dram_dfs_time = <0x96>;
			status = "okay";
			vind_mclkpin-supply = <0x45>;
			vind_mclkpin_vol = <0x1b7740>;
			vind_mcsipin-supply = <0x45>;
			vind_mcsipin_vol = <0x1b7740>;
			vind_mipipin-supply = <0x45>;
			...
			csi@5820000 {
				...
				ports {
            				...
            				port@0 {
                				reg = <0>;
                				csi0_in: endpoint {
                    					remote-endpoint = <&mipi_csi_a_out>;
                				};
            				};
			...
			mipi@5810100 {
				...
				ports {
            				...
            				port@0 {
                				reg = <0>;
                				mipi_csi_a_in: endpoint {
                    					remote-endpoint = <&gc2053_ir_out>;
                				};
            				};

            				port@1 {
                				reg = <1>;
                				mipi_csi_a_out: endpoint {
			...
			sensor@5812000 {
				...
				sensor0_dvdd_vol;
				sensor0_power_en;
				sensor0_reset = <0x53 0x0a 0x0b 0x01>;
				sensor0_pwdn;
				sensor0_sm_vs;
				flash_handle = <0x10e>;
				act_handle = <0x10f>;
			...
			sensor@5812010 {
				...
				sensor1_dvdd_vol;
				sensor1_power_en;
				sensor1_reset = <0x53 0x0a 0x0a 0x01>;
				sensor1_pwdn;
				sensor1_sm_vs;
				flash_handle;
				act_handle;
			...
			vinc@5832000 {
				...
				vinc8_mipi_sel = <0x00>;
				vinc8_isp_sel = <0x04>;
				vinc8_isp_tx_ch = <0x02>;
				vinc8_tdm_rx_sel = <0x00>;
				vinc8_rear_sensor_sel = <0x00>;
				vinc8_front_sensor_sel = <0x00>;
			...
			vinc@5833000 {
				...
				vinc12_csi_sel = <0x00>;
				vinc12_mipi_sel = <0x00>;
				vinc12_isp_sel = <0x04>;
				vinc12_isp_tx_ch = <0x03>;
				vinc12_tdm_rx_sel = <0x00>;
				vinc12_rear_sensor_sel = <0x00>;
				vinc12_front_sensor_sel = <0x00>;
		...
		deinterlace@5400000 {
			...
			iommus = <0x1d 0x06 0x01>;
			power-domains = <0x1e 0x03>;
			status = "okay";
			clocks = <0x19 0x33 0x19 0x34 0x19 0x19>;
		...
		gpu@1800000 {
			...
			clocks = <0x19 0x37 0x19 0x38 0x19 0x18>;
		...
		pcie@4800000 {
			...
			reg-names = "dbi";
			device_type = "pci";
			ranges = <0x800 0x00 0x20000000 0x00 0x20000000 0x00 0x1000000 0x81000000 0x00 0x21000000 0x00 0x21000000 0x00 0x1000000 0x82000000 0x00 0x22000000 0x00 0x22000000 0x00 0x7000000>;
			num-lanes = <0x01>;
			phys = <0xf7 0x02>;
			phy-names = "pcie-phy";
			...
			resets = <0x19 0x3b>;
			power-domains = <0x1e 0x07>;
			clocks = <0x19 0x92 0x19 0x09 0x21 0x19 0x9a>;
			clock-names = "pclk_ref\0pclk_per\0hosc\0pclk_aux";
			status = "disabled";
		};
		...
		codec@7110000 {
			...
			resets = <0x79 0x06>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x15 0x19 0x23 0x79 0x01 0x79 0x02 0x79 0x13 0x79 0x14>;
			...
			cpvin-vol = <0x1b7740>;
			pa-pin-max = <0x01>;
			pa-pin-0 = <0x64 0x00 0x07 0x00>;
			pa-pin-level-0 = <0x01>;
			pa-pin-msleep-0 = <0x00>;
			jack-det-level = <0x00>;
			jack-det-threshold = <0x08>;
			jack-det-debouce-time = <0xfa>;
			phandle = <0x112>;
		};
		...
		owa_plat@7116000 {
			...
			resets = <0x79 0x04>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x10 0x19 0x23 0x19 0x08 0x79 0x01 0x79 0x02 0x79 0x0e 0x79 0x0f>;
		...
		dmic_plat@7111000 {
			...
			resets = <0x79 0x05>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x12 0x19 0x23 0x79 0x01 0x79 0x02 0x79 0x11>;
		...
		i2s0_plat@7112000 {
			...
			resets = <0x79 0x03>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x0a 0x19 0x23 0x79 0x01 0x79 0x02 0x79 0x05>;
		...
		i2s0_mach {
			...
			status = "disabled";
			soundcard-mach,frame-master = <0x11c>;
			soundcard-mach,bitclock-master = <0x11c>;
			soundcard-mach,capture-only;
		...
		i2s1_plat@7113000 {
			...
			resets = <0x79 0x02>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x0b 0x19 0x23 0x79 0x01 0x79 0x02 0x79 0x06>;
			clock-names = "clk_pll_peri0_2x\0clk_dsp_src\0clk_dsp_core\0clk_bus_i2s\0clk_pll_audio0_4x\0clk_pll_audio1_div2\0clk_pll_audio1_div5\0clk_i2s";
			dmas = <0xc6 0x04 0xc6 0x04>;
			dma-names = "tx\0rx";
			playback-cma = <0x80>;
			capture-cma = <0x80>;
			tx-fifo-size = <0x80>;
		...
		i2s1_mach {
			...
			soundcard-mach,slot-width = <0x20>;
			status = "disabled";
			soundcard-mach,frame-master = <0x11e>;
			soundcard-mach,bitclock-master = <0x11e>;
		...
		i2s2_plat@7114000 {
			...
			resets = <0x79 0x01>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x0c 0x19 0x23 0x79 0x01 0x79 0x02 0x79 0x07>;
			clock-names = "clk_pll_peri0_2x\0clk_dsp_src\0clk_dsp_core\0clk_bus_i2s\0clk_pll_audio0_4x\0clk_pll_audio1_div2\0clk_pll_audio1_div5\0clk_i2s";
			dmas = <0xc6 0x05 0xc6 0x05>;
			dma-names = "tx\0rx";
			playback-cma = <0x80>;
			capture-cma = <0x80>;
			tx-fifo-size = <0x80>;
		...
		i2s3_plat@7115000 {
			...
			resets = <0x79 0x00>;
			clocks = <0x19 0x02 0x19 0xbc 0x79 0x04 0x79 0x0d 0x19 0x23 0x19 0x08 0x79 0x01 0x79 0x02 0x79 0x09 0x79 0x08>;
		...
		i2s3_mach {
			...
			soundcard-mach,slot-width = <0x20>;
			status = "disabled";
			soundcard-mach,frame-master = <0x123>;
			soundcard-mach,bitclock-master = <0x123>;
		...
		rfkill {
			...
			wlan {
				...
				clocks;
				clock-names;
				wlan_power = "axp2202-aldo3\0axp2202-bldo1";
				wlan_power_vol = <0x325aa0 0x1b7740>;
				wlan_busnum = <0x01>;
				wlan_regon = <0x53 0x06 0x0d 0x00>;
				wlan_hostwake = <0x53 0x06 0x0e 0x00>;
				wakeup-source;
			};
			...
			bt {
				...
				clocks;
				clock-names;
				bt_power = "axp2202-aldo3\0axp2202-bldo1";
				bt_power_vol = <0x325aa0 0x1b7740>;
				bt_rst_n = <0x53 0x06 0x0c 0x01>;
			};
		};
		...
		btlpm {
			...
			status = "okay";
			uart_index = <0x01>;
			bt_wake = <0x53 0x06 0x0b 0x00>;
			bt_hostwake = <0x53 0x06 0x0a 0x00>;
			wakeup-source;
		};
		...
		mdio0@4500048 {
			...
			ethernet-phy@1 {
				reg = <0x01>;
				max-speed = <0x3e8>; // 1000 = 1G
				reset-gpios = <0x53 0x09 0x10 0x01>; // PJ16
		...
		ethernet@4510000 {
			...
			clocks = <0x19 0x83 0x19 0x58 0x19 0x82>;
			...
			status = "disabled";
			snps,fixed-burst;
			snps,axi-config = <0x129>;
			snps,mtl-rx-config = <0x12a>;
			snps,mtl-tx-config = <0x12b>;
			phy-mode = "rgmii";
			pinctrl-names = "default\0sleep";
			pinctrl-0 = <0x12c>;
			pinctrl-1 = <0x12d>;
			...
			mdio1@1 {
				...
				ethernet-phy@1 {
					...
					reg = <0x01>;
					max-speed = <0x3e8>;
					reset-gpios = <0x53 0x09 0x10 0x01>;
					reset-assert-us = <0x2710>;
					reset-deassert-us = <0x249f0>;
					phandle = <0x128>;
				};
	...
	chosen {
		bootargs = "root=UUID=f6083a17-39df-4baa-ab19-8309e9867e32 earlycon=uart8250,mmio32,0x02500000 clk_ignore_unused initcall_debug=0 console=ttyAS0,115200 loglevel=8 cma=64M init=/sbin/init rw no_console_suspend consoleblank=0 fsck.fix=yes fsck.repair=yes net.ifnames=0 splash plymouth.ignore-serial-consoles hdmi_mode=1080p60 hdmi_hpd=1";
	};
	...
	edp_backlight {
		...
		enable-gpios = <0x53 0x08 0x05 0x00>;
		pwms = <0x50 0x05 0x4c4b40 0x00>;
		phandle = <0x130>;
	};
	...
	backlight0 {
		...
		brightness-levels = <>;
		default-brightness-level = <0xc8>; // 200 out of 255
		//enable-gpios = <0x53 0x08 0x02 0x00>;
		pwms = <0x50 0x0a 0xf4240 0x00>; // PWM0_10 1KHz
		phandle = <0x132>;
	};
